...
//		newcallback("ab",              std::bind(&GTP::gtp_ab,            this, _1), "Switch to use the Alpha/Beta agent to play/solve");
		...
		newcallback("solver",		   std::bind(&GTP::gtp_solver,		  this, _1), "Switch to use the custom Bridg-It Solver");
...
//	GTPResponse gtp_ab_params(vecstr args);
	...
	GTPResponse gtp_solver(vecstr args);
	GTPResponse gtp_solver_params(vecstr args);
